...
public class ABGTrendsActivity extends AppCompatActivity {
    ...
    private void fetchABGTrends() {
        ...
        apiService.getABGTrends(patientId).enqueue(new Callback<ABGTrendResponse>() {
            @Override
    ...
    private void populateUI(ABGTrendResponse data) {
        ...
        if (entries == null || entries.isEmpty()) {
            tvTrendAnalysis.setText("No ABG data available for this patient.");
            return;
        }

        // Extract data arrays and time labels
