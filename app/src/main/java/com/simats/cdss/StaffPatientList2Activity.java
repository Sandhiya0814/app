...
public class StaffPatientList2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_staff_patient_list2);

        fromAction = getIntent().getStringExtra("from_action");
        ...
        // Set click listeners for patient cards to move based on action
        View.OnClickListener patientClickListener = v -> {
            Intent intent;
            if ("symptoms".equals(fromAction)) {
                intent = new Intent(this, CurrentSymptomsActivity.class);
            } else if ("abg_trends".equals(fromAction)) {
                intent = new Intent(this, ABGTrendsActivity.class);
            } else {
                intent = new Intent(this, VitalsActivity.class);
            }
